...
ws.onmessage = function (evt) {
    ...
    // Final photostrip displayed
        ...
        tmp_output += "<form action='javascript:void(0);'>Print More Copies? (1 - 3)<br /> <input type='number' value='1' id='pcopy' min='1' max='3'> <a onclick='printMore()'>Print More!</a></form> "
        tmp_output += "<br /><br />";
